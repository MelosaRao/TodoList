...
import { getlocalstorage, setlocalstorage,setcurrentproject,getcurrentproject } from './localstorage.js';
...
if(getlocalstorage()==null){
    ...
    applist = [defaultProject];
    setlocalstorage(applist)
    ...
    applist = getlocalstorage()
    defaultProject = applist[0];

    applist.forEach((project)=>{
        displaynewProject(project,sidebar)
    })
...
function addNewTask(){
    ...
    current_project.projectlist.push(todo_to_add)
...
/*function setlocalstorage(applist){
    ...
    console.log(`stored projects ${storedProjectsJsonString}`)
